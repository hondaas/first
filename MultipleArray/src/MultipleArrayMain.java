...
public class MultipleArrayMain {
	...
	*
		 * int[][] scoresInClasses = new int[3][3]; scoresInClasses[0][0] = 100;
		 * scoresInClasses[0][1] = 100; scoresInClasses[0][2] = 90;
		 * 
		 * scoresInClasses[1][0] = 90; scoresInClasses[1][1] = 10;
		 * scoresInClasses[1][2] = 70;
		 * 
		 * scoresInClasses[2][0] = 70; scoresInClasses[2][1] = 100;
		 * scoresInClasses[2][2] = 95;
		 *

		/*int[][] scoresInClasses = new int[3][]; // 열에 몇개가 들어갈지 모름
